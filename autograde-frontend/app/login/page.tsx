...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen grid grid-cols-1 md:grid-cols-[1fr_1.1fr]">
      ...
      {/* ─── LEFT — clean white form side like Dribbble ─── */}
      ...
      >
        ...
        <div className="absolute bottom-10 left-8 right-8 z-10">
          <div className="bg-grey bg-opacity-10 backdrop-blur-md border border-grey border-opacity-20 rounded-2xl p-6 text-white">
            ...
            <p className="text-xs text-white text-opacity-60 leading-relaxed">
              Upload assessments, configure grading criteria, and review AI-generated feedback — all in one place.
            </p>

            {/* Stats row */}
            <div className="flex gap-6 mt-4 pt-4 border-t border-white border-opacity-10">
              <div>
                <p className="text-lg font-black">98%</p>
                <p className="text-xs text-white text-opacity-50">Accuracy rate</p>
              </div>
              <div>
                <p className="text-lg font-black">10x</p>
                <p className="text-xs text-white text-opacity-50">Faster grading</p>
              </div>
              <div>
                <p className="text-lg font-black">500+</p>
                <p className="text-xs text-white text-opacity-50">Educators</p>
              </div>
            </div>
          </div>
        </div>

...
// Validate ../../src/app/api/password-reset/confirm/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/password-reset/confirm">> = Specific
  const handler = {} as typeof import("../../src/app/api/password-reset/confirm/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}

// Validate ../../src/app/api/password-reset/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/password-reset">> = Specific
  const handler = {} as typeof import("../../src/app/api/password-reset/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
